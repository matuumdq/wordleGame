    ...
    <div className="flex flex-col h-[85vh] items-center justify-center cursor-default mt-20">
        ...
        { store.lost && (
            <div className='text-center'>
                ...
                <div 
                    className=' bg-black p-5 rounded-lg m-5 hover:scale-105 ease-in duration-300 shadow-lg hover:shadow-[#9e2f2f]'>
                    <div
                    ...
                    <div className='flex text-center justify-center items-center gap-2 m-3'>
                        <h2 className='uppercase font-bold text-2xl text-gray-400'>Better Luck next time! </h2>
                ...
                <button  
                    onClick={store.init}
                    className=' bg-black p-3 rounded-lg m-3 hover:scale-105 ease-in duration-300 shadow-lg hover:shadow-[#13e7e4]'>
                    <div
